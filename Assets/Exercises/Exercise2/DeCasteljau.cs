...
public class DeCasteljau : MonoBehaviour
{
    ...
    Vector3 EvaluateAt(float u)
    {
        ...
        Vector3 midHalf1 = Vector3.Lerp(mid1, mid2, u);
        Vector3 midHalf2 = Vector3.Lerp(mid2, mid3, u);

        return Vector3.Lerp(midHalf1, midHalf2, u);
    }
    ...
    void Update()
    {
        if (cp1 == null || cp2 == null || cp3 == null || cp4 == null) return;
        DebugDrawCurve();
    }
}
